        ...
        <div class="grid gap-6 lg:grid-cols-[1.15fr,1fr] items-center">
          ...
          <div class="flex items-start gap-5 lg:ml-4">
            <div class="hidden sm:flex shrink-0 w-[90px] h-[90px] items-center justify-center">
              <img src="<?php echo e(asset('images/Logo-Symbol.png')); ?>" alt="HELP VENEZUELAN REFUGEES" class="w-[80px] h-auto" />
            </div>

            <div class="sm:pt-1">
              <p class="text-[16px] sm:text-[20px] uppercase tracking-[0.16em]- text-[#FEE79D] font-semibold">
                 <?php echo e(translate('HELP VENEZUELAN REFUGEES')); ?>

              </p>

              <div class="mt-3 text-[26px] sm:text-[34px] lg:text-[40px] leading-[1.05] font-semibold uppercase">
                <?php echo translate('SUBSCRIBE TO OUR NEWSLETTER'); ?>
...
<div class="hidden lg:flex justify-end md:mr-10">
  <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="post"
    ...
    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter your email"
...
<div class="hidden md:block lg:hidden w-full px-4">
  <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="w-full max-w-[720px] mx-auto">
    <?php echo csrf_field(); ?>
...
<div class="md:hidden">
    <form class="newsletterForm" action="<?php echo e(route('newsletter.subscribe')); ?>" method="post">
    <?php echo csrf_field(); ?>

    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Insert Your email"
    ...
    <div class="sm:hidden text-center">
        ...
        <div class="mt-3">
            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $setting->whatsapp_number)); ?>?text=<?php echo e(urlencode('Hello, I want to know more details.')); ?>"
               ...
               class="uppercase font-semibold text-[#1f66c2] underline underline-offset-4">
                  <?php echo e(translate('Contact us on whatsapp')); ?> &gt;
            </a>
        </div>
        ...
        <div class="flex items-center justify-center gap-4">
            <a href="<?php echo e($setting->fb_url); ?>" target="_blank"
            ...
            <a href="<?php echo e($setting->instragram_url); ?>" target="_blank"
        ...
        <div class="mt-4">
            <a href="#"
               class="text-[#1f66c2] text-[16px] underline underline-offset-4">
                <?php echo e(translate('Follow us on our social media')); ?>
    ...
    <div class="hidden sm:flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $setting->whatsapp_number)); ?>?text=<?php echo e(urlencode('Hello, I want to know more details.')); ?>"
           class="inline-flex items-center gap-3 font-semibold text-[#007c2e]" target="_blank">
            ...
            <span class="uppercase"> <?php echo e(translate('Contact us on whatsapp')); ?> &gt; </span>
        </a>
        ...
        <div class="flex items-center gap-3">
            <div class="flex items-center gap-2 text-[16px]">
                <a href="<?php echo e($setting->fb_url); ?>" class="text-[#1877F2]" target="_blank"><i class="fab fa-facebook-f text-3xl"></i></a>
                <a href="<?php echo e($setting->twitter_url); ?>" class="text-[#1DA1F2]" target="_blank"><i class="fab fa-twitter text-3xl"></i></a>
                <a href="<?php echo e($setting->instragram_url); ?>" class="text-[#E4405F]" target="_blank"><i class="fab fa-instagram text-3xl"></i></a>
                <a href="<?php echo e($setting->youtube_url); ?>" class="text-[#FF0000]" target="_blank"><i class="fab fa-youtube text-3xl"></i></a>
            </div>
...
<?php /**PATH C:\Users\MalcaCorp\Desktop\proyecto\public_html\resources\views/frontend/includes/news_letter.blade.php ENDPATH**/ ?>