...
<?php $__env->startSection('title', 'Report Create'); ?>
...
<div class="container-fluid pt-3">
    <form id="storyCreateForm" action="<?php echo e(route('stories.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                            ...
                            <select name="campaign_id"
                                ...
                                <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>"
                                        <?php echo e(old('campaign_id') == $item->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                        ...
                                        class="form-control"  
                                        value="<?php echo e(old('title.' . $langCode, $report->title[$langCode] ?? '')); ?>"
                                    ...
                                    <?php $__errorArgs = ['title.' . $langCode];
                        ...
                        <?php if($language->language_code === $locale): ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_description[<?php echo e($langCode); ?>]" 
                                            rows="3" 
                                            class="form-control" 
                                            placeholder="Short description"><?php echo e(old('short_description.' . $langCode, $report->short_description[$langCode] ?? '')); ?></textarea>
                                    <?php $__errorArgs = ['short_description.' . $langCode];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description[<?php echo e($langCode); ?>]" 
                                            id="summernote_<?php echo e($langCode); ?>" 
                                            class="summernote form-control" 
                                            placeholder="Report Content"
                                            rows="5"><?php echo e(old('description.' . $langCode, $report->description[$langCode] ?? '')); ?></textarea>
                                    <small class="seo-subtitle mb-0 label-color">
                            ...
                            <?php if($language->language_code === $locale): ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group page-url-group">
                                        ...
                                        <input type="text" id="slug" name="slug[<?php echo e($code); ?>]" value="<?php echo e(old('slug.' . $code)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($language->language_code === $locale): ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_title[<?php echo e($langCode); ?>]" class="form-control" placeholder="SEO title (<?php echo e($langCode); ?>)"  value="<?php echo e(old('seo_title.' . $langCode)); ?>" required>
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = App\Models\Language::where('active', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tags  (<?php echo e($langCode); ?>)</label>
                                <input type="text" name="tags[<?php echo e($langCode); ?>]" class="form-control" placeholder="tags (<?php echo e($langCode); ?>)"  value="<?php echo e(old('tags.' . $langCode)); ?>">
                            </div>
                        </div>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($language->language_code === $locale): ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="meta_description[<?php echo e($langCode); ?>]" rows="3" 
                                        class="form-control" placeholder="Description for google meta tags (<?php echo e($langCode); ?>)"><?php echo e(old('meta_description.' . $langCode)); ?></textarea>
                        ...
                        <?php if($language->language_code === $locale): ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="footer_title[<?php echo e($code); ?>]" class="form-control" value="<?php echo e(old('footer_title.' . $code)); ?>">
                                    <small class="seo-subtitle mb-0 label-color">
                        ...
                        <?php if($language->language_code === $locale): ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="footer_subtitle[<?php echo e($code); ?>]" class="form-control" value="<?php echo e(old('footer_subtitle.' . $code)); ?>">
                                    <small class="seo-subtitle mb-0 label-color">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                <input type="text" name="published_at" class="form-control datetimepicker-input" data-target="#reservationdatetime"  value="<?php echo e(old('published_at')); ?>"/>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/saingo/public_html/resources/views/admin/story/create.blade.php ENDPATH**/ ?>