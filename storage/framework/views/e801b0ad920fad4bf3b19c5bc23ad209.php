...
<?php $__env->startSection('title', 'Report Edit'); ?>

<?php $__env->startSection('css'); ?>
<link rel="stylesheet" href="<?php echo e(asset('backend-asset/plugins/summernote/summernote-bs4.min.css')); ?>">
<style>
...
?>
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap mb-3">
            <div class="mb-3 mb-md-0">
                <h3 class="mb-2 font-weight-bold main-page-heading">
                    Edit Report —
                    <a href="javascript:void(0)" class="text-primary"><?php echo e($story->title); ?></a>
                </h3>

                <div class="small">
                    <a href="<?php echo e(url('/dashboard')); ?>" class="text-primary">Dashboard</a>
                    <span class="text-muted mx-1">/</span>
                    <a href="<?php echo e(route('stories.index')); ?>" class="text-primary">Report</a>
                    <span class="text-muted mx-1">/</span>
                    <span class="text-muted">Edit — <?php echo e($story->title); ?></span>
                </div>
            </div>

            <div class="d-flex flex-wrap">
                <a href="<?php echo e(route('stories.index')); ?>" class="btn btn-sm btn-default mr-2 mb-2 mb-md-0 w3-round-large">
                    <i class="far fa-file-alt mr-1"></i> All Report
                </a>

                <a href="<?php echo e(session('locale', config('app.locale')) === 'es' ? route('blogDetailsEs', $story->slug) : route('blogDetails', $story->slug)); ?>" class="btn btn-sm btn-dark mb-2 mb-md-0 w3-round-large" target="_blank">
    ...
    <div class="container-fluid pt-3">
        <form id="storyUpdateForm" action="<?php echo e(route('stories.update', $story->id)); ?>"  method="POST"  enctype="multipart/form-data">
                                ...
                                <select name="campaign_id" class="form-control select2" data-dropdown-css-class="select2-danger" required>
                                    ...
                                    <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>"
                                            <?php echo e($item->id == $story->campaign_id ? 'selected' : ''); ?>>
                                ...
                                <select name="user_id" class="form-control select2" data-dropdown-css-class="select2-danger" required>
                                    ...
                                    <?php $__currentLoopData = $author; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>"
                                            <?php echo e($user->id == $story->addedby_id ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control select2" data-dropdown-css-class="select2-danger" required>
                                    ...
                                    <option value="<?php echo e($item->id); ?>" <?php echo e($story->category_id == $item->id ? 'selected' : ''); ?>><?php echo e($item->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <small class="seo-subtitle mb-0 label-color">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control"
                                            value="<?php echo e(old('title.' . $code, $story->localeTitle($code))); ?>"
                            ...
                            <?php if($language->language_code === $locale): ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        ><?php echo e(old('short_description.' . $code, $story->localeExcerpt($code))); ?></textarea>
                                        <small class="seo-subtitle mb-0 label-color">
                            ...
                            <?php if($language->language_code === $locale): ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  name="description[<?php echo e($code); ?>]"  class="summernote form-control"
                                        rows="5"><?php echo e(old('description.' . $code, $story->localeDescription($code))); ?></textarea>
                                        <small class="seo-subtitle mb-0 label-color">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group page-url-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="<?php echo e(old('reportpath.' . $code, $story->getDirectValue('reportpath', $code))); ?>/<?php echo e(old('slug.' . $code, $story->getDirectValue('slug', $code))); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="callout callout-info- mt-3 mb-0 py-1" style="background-color: #DFF5F3;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0">
                                                sai.ngo/<?php echo e($story->reportpath); ?>/<?php echo e($story->slug); ?>
                                ...
                                <div class="col md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control"
                                            value="<?php echo e(old('seo_title.' . $code, $story->localSeoTitle($code))); ?>" placeholder="Meta title shown in search engine results...">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-2 mt-2 seo-note-wrap">
                                            ...
                                            <small class="seo-count-text">
                                                <span id="seo_title_count_<?php echo e($code); ?>">
                                                    <?php echo e(mb_strlen(old('seo_title.' . $code, $story->getDirectValue('seo_title', $code)) ?? '')); ?>
                            ...
                            <?php if($language->language_code === $locale): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            name="tags[<?php echo e($code); ?>]"
                                            class="form-control"
                                            value="<?php echo e(old('tags.' . $code, $story->localTag($code))); ?>"
                            ...
                            <?php if($language->language_code === $locale): ?>
                                ...
                                <div class="col-md-12"> 
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description[<?php echo e($code); ?>]" rows="3" 
                                            class="form-control" placeholder="Description for google meta tags (<?php echo e($code); ?>)"><?php echo e(old('meta_description.' . $code, $story->localMetaDescription($code))); ?></textarea>
                                        <small class="seo-help-text">
                            ...
                            <?php if($language->language_code === $locale): ?> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="footer_title[<?php echo e($code); ?>]" class="form-control" value="<?php echo e(old('footer_title.' . $code, $story->getDirectValue('footer_title', $code))); ?>" placeholder="e.g. Help People in Need">
                                        <small class="seo-subtitle mb-0 label-color">
                            ...
                            <?php if($language->language_code === $locale): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="footer_subtitle[<?php echo e($code); ?>]" class="form-control" value="<?php echo e(old('footer_subtitle.' . $code, $story->getDirectValue('footer_subtitle', $code))); ?>" placeholder="e.g. Start donating today, make the difference">
                                        <small class="seo-subtitle mb-0 label-color">
    ...
    <?php echo e(ucfirst($langCode->language_code)); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    <option value="draft" <?php echo e($story->status == 'draft' ? 'selected' : ''); ?>>draft</option>
                                    <option value="published" <?php echo e($story->status == 'published' ? 'selected' : ''); ?>>published</option>
                                </select>
                                <small class="seo-subtitle mb-0 label-color">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                    <input type="text" name="published_at" class="form-control datetimepicker-input" data-target="#reservationdatetime" value="<?php echo e(old('published_at', optional($story->published_at)->format('Y-m-d'))); ?>"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    name="position"
                                    class="form-control"
                                    value="<?php echo e(old('position', $story->position)); ?>" placeholder="Enter position">
                            </div>
                        </div> -->
                    </div>
                </div>
            ...
            <div class="card-footer text-right  w3-round-large">
                <a href="<?php echo e(route('stories.index')); ?>" id="discardBtn" class="btn btn-sm mr-2 w3-round-large" style="background-color: #afb3ba;">
            ...
            <?php echo $__env->make('admin.story.story_preview_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </form>
    </div>
...
<?php echo $__env->make('admin.summernote_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<script src="<?php echo e(asset('backend-asset/plugins/summernote/summernote-bs4.min.js')); ?>"></script>


<script src="<?php echo e(asset('backend-asset/plugins/moment/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend-asset/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')); ?>"></script>

<script src="<?php echo e(asset('backend-asset')); ?>/summernote-custom-input.js"></script>
...
<script>
    $(document).ready(function () {
        ...
        $('#saveUrlBtn').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('story.update.inline.url', $story->id)); ?>",
                type: "POST",
                data: {
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/saingo/public_html/resources/views/admin/story/edit.blade.php ENDPATH**/ ?>