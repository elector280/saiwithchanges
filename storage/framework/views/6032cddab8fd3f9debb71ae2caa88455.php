<aside id="campaignSidebar" aria-label="Donation and newsletter sidebar"
  ...
  <?php if(!empty($campaign->donorbox_code)): ?>
    <div class="w-full max-w-none bg-white border border-gray-200 rounded-sm shadow-md overflow-hidden
      ...
      <?php echo $campaign->donorbox_code; ?>
  ...
  <div class="bg-gradient-to-b from-[#ff5c5c] to-[#f48a4b] rounded-sm shadow-md p-5 text-white text-xs">
    ...
    <h4 class="text-xl font-semibold mb-3">
      <?php echo e(translate('SUBSCRIBE CAMPAIGN NEWSLETTER')); ?>

    </h4>

    <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="post" class="newsletterForm w-full max-w-[560px] relative">
      <?php echo csrf_field(); ?>

      <p class="newsletterMsg mb-2 rounded-md px-4 my-2 py-2 text-sm hidden" role="status" aria-live="polite"></p>

      <label for="newsletterEmail" class="sr-only"><?php echo e(translate('Email address')); ?></label>
...
<?php /**PATH /home/saingo/public_html/resources/views/frontend/includes/donate_box.blade.php ENDPATH**/ ?>