    ...
    <div class="relative max-w-7xl px-4 mx-auto md:py-5">
        ...
        <div class="lg:hidden">
            ...
            <div class="mt-10 grid grid-cols-3 gap-3 text-[11px]">
                ...
                <div>
                    <h3 class="font-semibold uppercase text-white/80"><?php echo e(translate('Donations')); ?></h3>
                    <ul class="mt-3 space-y-2 text-white/70">
...
<?php /**PATH C:\Users\MalcaCorp\Desktop\proyecto\public_html\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>