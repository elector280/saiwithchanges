...
<?php $__env->startSection('title',  $setting->getLocalValue('title') ?? translate('Home page meta title')); ?>
<?php $__env->startSection('meta_description',  $setting->getLocalValue('subtitle') ?? translate('Home page meta description')); ?>
<?php $__env->startSection('meta_keyword',  $setting->getLocalValue('meta_keyword') ?? translate('Home page meta keyword')); ?>
    ...
    <section class="py-6 lg:py-16 bg-[#f6f6f6]">
        <div class="max-w-6xl px-3 md:px-0 mx-auto space-y-10">
            ...
            <div class="grid text-sm text-slate-800 md:grid-cols-3 gap-6 md:gap-10 items-start">
                ...
                <article class="flex flex-col h-full">
                    <h3 class="text-[26px] font-bold tracking-[0.04em] text-[#e13b35] uppercase">
                        <?php echo e(translate('Become a Sponsor')); ?>
...
<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MalcaCorp\Desktop\proyecto\public_html\resources\views/frontend/home.blade.php ENDPATH**/ ?>