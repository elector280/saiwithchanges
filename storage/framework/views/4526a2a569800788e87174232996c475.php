...
<?php $__env->startSection('title', $cam->title ?? 'Mini Campaign Preview'); ?>
<?php $__env->startSection('meta_description', $cam->meta_description ?? ''); ?>
<?php $__env->startSection('meta_keyword', $cam->meta_keywords ?? ''); ?>
...
<section id="top" class="pt-4 pb-10 bg-[#f5f5f5] -mt-10 md:-mt-36 relative z-0">
    <div class="relative rounded-sm overflow-hidden shadow-lg bg-center hero-fallback"
         style="<?php echo e(!empty($cam->cover_image_url) ? "background-image: url('".$cam->cover_image_url."');" : ''); ?> height: 600px;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/saingo/public_html/resources/views/frontend/mini_campaign.blade.php ENDPATH**/ ?>