    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                <h4 class="float-end font-size-16"><strong>Order No # {{ $invoice->invoice_no }}</strong></h4>
                <h3>
                    <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="logo" height="24"/> WareFlow BD
                </h3>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-6 mt-4">
                    <address>
                        <strong>WareFlow BD:</strong><br>
                        Dhaka, Bangladesh<br>
                        info.wareflowbd@gmail.com
                    </address>
                </div>
      ...
      @php
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-end">৳{{ $invoice->delivery_fee }}</td>
            </tr>
             <tr>
                <td class="no-line"></td>
                 <td class="no-line"></td>
