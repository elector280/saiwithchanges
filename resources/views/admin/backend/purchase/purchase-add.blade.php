                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <div class="form-group col-sm-10">
                                            <input type="number" name="purchase_no" class="form-control example-date-input"
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <div class="form-group col-sm-10">
                                            ...
                                            <i
                                                class="btn btn-secondary btn-rounded waves-effect waves-light fa fa-plus-circle addeventmore">
                                                Add More</i>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form method="post" action="{{ route('purchase.store') }}">
                                ...
                                <table class="table-sm table-bordered" width="100%" style="border-color: #ddd;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="5"></td>
                                            <td><input type="text" name="estimated_amount"
                                                    class="form-control estimated_amount" id="estimated_amount"
                                                    value="0" style="background-color: #ddd;" readonly></td>
                                            <td></td>
                                        </tr>
                                    </tbody>
                                </table><br>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(document).on("click", ".addeventmore", function() {
                ...
                if (supplier_id == '') {
                    $.notify("Supplier no is required", {
                        globalPosition: 'top right',
                        className: 'error'
                    });
                    return false;
                ...
                if (category_id == '') {
                    $.notify("Category no is required", {
                        globalPosition: 'top right',
                        className: 'error'
                    });
                    return false;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            html += '<option value="' + value.category_id + '">' + value
