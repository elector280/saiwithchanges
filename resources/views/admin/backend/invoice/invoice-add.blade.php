                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-1">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">Stock(Pcs/Dzn)</label>
                                    <div class="form-group col-sm-10">
                     ...
                     <div class="card-body">
                        <form method="post" action="{{ route('invoice.store') }}">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info" id="storeButton">Order Store</button>
                            </div>
                        </form>
                     </div>
                </div>
