    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4>Order No: # {{ $invoice->invoice_no }}- {{ date('d-m-Y',strtotime($invoice->date)) }}</h4>
                        <a href="{{ route('invoice.pending.list') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right"><i class="fa fa-list">Pending Order List</i></a><br><br>
                        <table class="table table-dark" width="100%">
                            <tbody>
                                <tr>
                                    <td><p>Customer Info</p></td>
                                    <td><p>Name <strong>{{ $payment['customer']['name'] }}</strong></p></td>
                                    <td><p>Name <strong>{{ $payment['customer']['mobile_no'] }}</strong></p></td>
                                    <td><p>Name <strong>{{ $payment['customer']['email'] }}</strong></p></td>
                                </tr>
                                <tr>
                                    <td></td>
                            ...
                            <table bordered class="table table-dark">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Unti Price</th>
