                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select name="header_photo_layout" id="header_photo_layout" class="form-control">
                                <option value="object-cover object-center" {{ ($campaign->header_photo_layout ?? '') == 'object-cover object-center' ? 'selected' : '' }}>Cover Center (Default)</option>
                                <option value="object-cover object-top" {{ ($campaign->header_photo_layout ?? '') == 'object-cover object-top' ? 'selected' : '' }}>Cover Top</option>
                                <option value="object-cover object-bottom" {{ ($campaign->header_photo_layout ?? '') == 'object-cover object-bottom' ? 'selected' : '' }}>Cover Bottom</option>
                                <option value="object-contain object-center" {{ ($campaign->header_photo_layout ?? '') == 'object-contain object-center' ? 'selected' : '' }}>Contain</option>
                                <option value="object-fill" {{ ($campaign->header_photo_layout ?? '') == 'object-fill' ? 'selected' : '' }}>Fill (Stretch)</option>
                            </select>
                            <small class="seo-subtitle mb-0 label-color">
                    ...
                    <div class="col-md-6">
                        ...
                        <div style="border: 1px dashed #ccc; padding: 5px; border-radius: 5px; background: #f9f9f9;">
                            <div class="relative w-full h-[190px] md:h-[250px] overflow-hidden bg-gray-200" style="height: 250px; width: 100%; position: relative; overflow: hidden; background-color: #e5e7eb;">
                                @if($campaign->header_photo)
                                    <img id="header_photo_preview" src="{{ asset('storage/hero_image/'.$campaign->header_photo) }}" style="width: 100%; height: 100%;" class="{{ $campaign->header_photo_layout ?? 'object-cover object-center' }}">
                                ...
                                @else
                                    <img id="header_photo_preview" src="" style="width: 100%; height: 100%; display: none;" class="{{ $campaign->header_photo_layout ?? 'object-cover object-center' }}">
...
if (headerPhotoInput && headerPhotoPreview && headerPhotoLayout) {
    headerPhotoInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            @if($campaign->header_photo)
                headerPhotoPreview.src = "{{ asset('storage/hero_image/'.$campaign->header_photo) }}";
            @else
