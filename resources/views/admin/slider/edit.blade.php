                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="title[{{ $langCode }}]" value="{{ old('title.' . $langCode,  $slider->localeTitle($langCode)) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="btn_text[{{ $langCode }}]" value="{{ old('btn_text.' . $langCode,  $slider->localeBtnText($langCode)) }}"
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Optional subtitle ({{ $language->title }})">{{ old('subtitle.' . $langCode, $slider->localeSubTitle($langCode)) }}</textarea>
