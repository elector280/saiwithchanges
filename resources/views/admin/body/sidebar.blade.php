         ...
         <div id="sidebar-menu">
             ...
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         <li><a href="{{ route('invoice.all') }}">All Order</a></li>
                         <li><a href="{{ route('invoice.pending.list') }}">Approval Order</a></li>
                         <li><a href="{{ route('print.invoice.list') }}">Print Order</a></li>
                         <li><a href="{{ route('daily.invoice.report') }}">Daily Order Report</a></li>
                     </ul>
                 </li>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         <li><a href="{{ route('slider.all') }}">All Slider</a></li>
                     </ul>
                 </li>
             </ul>
         </div>
