                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-16">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex items-baseline gap-1">
                                        <span class="text-[42px] lg:text-[44px] font-semibold text-slate-800 leading-none">
                                            @if(!empty($setting->peaple_helped))
                                                {!! $setting->peaple_helped !!}
                                            @endif
                                        </span>
                                        <span class="text-lg md:text-xl text-slate-600">
                                            {{ translate('People Helped') }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex items-baseline gap-1">
                                        <span class="text-[42px] lg:text-[44px] font-semibold text-[#1F6FEB] leading-none">
                                            @if(!empty($setting->educated_children))
                                                {!! $setting->educated_children !!}
                                            @endif
                                        </span>
                                        <span class="text-lg md:text-xl text-slate-600">
                                            {{ translate('Educated children') }}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="py-6 md:py-8">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex items-baseline gap-1">
                                        <span class="text-[42px] lg:text-[44px] font-semibold text-slate-800 leading-none">
                                            @if(!empty($setting->service_meal))
                                                {!! $setting->service_meal !!}
                                            @endif
                                        </span>
                                        <span class="text-lg md:text-xl text-slate-600">
                                            {{ translate('Served Meal') }}
                                        </span>
                                    </div>
                                </div>
